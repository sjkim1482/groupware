...
public class PmsVo {
	...
	public PmsVo(int pms_no, String app_char, int emp_no, int app_emp_no, String pms_nm, String cont, Date s_dt,
			Date e_dt, Date dest_time, int prog, int sta_cd, Date reg_dt, String dept_nm, String ko_nm, String title,
			int attend_emp_no, String pri_order_nm, String sta_cd_nm, int est_time, int work_no, int higher_work_no,
			String work_nm, int pri_order, int workLevel) {
		super();
		this.pms_no = pms_no;
	...
	public PmsVo(int pms_no, String app_char, int emp_no, int app_emp_no, String pms_nm, String cont, Date s_dt,
			Date e_dt, Date dest_time, int prog, int sta_cd, Date reg_dt, String dept_nm, String ko_nm,
			int attend_emp_no, String pri_order_nm, String sta_cd_nm, int est_time, int work_no, int higher_work_no,
			String work_nm, int pri_order, int workLevel) {
		super();
		this.pms_no = pms_no;
	...
	public String toString() {
		return "PmsVo [pms_no=" + pms_no + ", app_char=" + app_char + ", emp_no=" + emp_no + ", app_emp_no="
				+ app_emp_no + ", pms_nm=" + pms_nm + ", cont=" + cont + ", s_dt=" + s_dt + ", e_dt=" + e_dt
				+ ", Dest_time=" + Dest_time + ", prog=" + prog + ", sta_cd=" + sta_cd + ", reg_dt=" + reg_dt
				+ ", dept_nm=" + dept_nm + ", ko_nm=" + ko_nm + ", title=" + title + ", attend_emp_no=" + attend_emp_no
				+ ", pri_order_nm=" + pri_order_nm + ", sta_cd_nm=" + sta_cd_nm + ", est_time=" + est_time
				+ ", work_no=" + work_no + ", higher_work_no=" + higher_work_no + ", work_nm=" + work_nm
				+ ", pri_order=" + pri_order + ", workLevel=" + workLevel + "]";
	}
