							...
							<div class="input-group" style="float: left;">
								<div class="mailbox-attachments clearfix" style="text-align: center; width: 100%;">
									<div class="mailbox-attachment-icon has-img" id="pictureView" style="border: 1px solid green; height: 150px; width: 120px; margin: 0 auto;">
										<a href="${cp }/empController/profileDownload?emp_id=${detailUser.emp_id}">
...
<!-- 							<div class="form-group row" style="float: right;" > -->
							<div class="form-group row">
								...
								<div class="col-sm-10 input-group input-group-sm">
									...
									${detailUser.zipcode} / ${detailUser.addr1} , ${detailUser.addr2}</span>
								</div>
...
<%-- 												<fmt:formatDate value="${detailUser.retire_dt}" pattern="yyyy-MM-dd"/></span> --%>
							...
							<div class="card-footer">
								<div class="row" >
									...
									<input type="button" id="modifyBtn" class="btn btn-default" style="float: right; margin-right: 20px;" value="수정" data-emp_no="${detailUser.emp_no}">
								</div>
							</div>
						</div>
