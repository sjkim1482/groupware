...
<div class="col-md-12">
	<div class="panel panel-default">
		...
		<div class="panel-body" style="display: block; height: 800px; min-width: 500px;">
			<form action="/pms/modifyPms" method="post" id="frm"
				...
				<div class="form-group">
					<input type="text" id="attend_emp_no" name="attend_emp_no"	value="${S_USER.emp_no}"> 
					<input type="text" id="pms_no" name="pms_no" value="${workVo.pms_no}">
					<input type="text" id="work_no" name="work_no" value="${workVo.work_no}">
				</div>
