...
<!-- 			</form> -->
			...
			<table class="table table-inbox table-hover" style="width: 100%">
				<tbody>
					...
					<c:forEach items="${msgList}" var="msg" varStatus="status">
							...
							<tr class="rec_msg_no unread" data-msg_no="${msg.msg_no}">
								<td>
	...
	<a href="javascript:pagingMsgBoxMsgAjaxHtml(1, ${pageVo.pageSize},${msgBox.msg_box_no},'${msgBox.msg_box_nm}');">&lt;&lt;</a></li>
...
<%-- 			<a href="#">${i}</a></li> --%>
		...
		<c:otherwise>
			<li class="paginate_button " aria-controls="example" tabindex="0">
				<a href="javascript:pagingMsgBoxMsgAjaxHtml(${i }, ${pageVo.pageSize},${msgBox.msg_box_no},'${msgBox.msg_box_nm}');">${i }</a></li>
		</c:otherwise>
	</c:choose>
...
<li class="paginate_button next" aria-controls="example" tabindex="0" id="example_next">
	<a href="javascript:pagingMsgBoxMsgAjaxHtml(${pagination}, ${pageVo.pageSize},${msgBox.msg_box_no},'${msgBox.msg_box_nm}');">&gt;&gt;</a></li>
			</ul>
		</div>
	</div>
</div>	
