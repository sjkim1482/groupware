						...
						<form method="post" enctype="multipart/form-data" id="profilForm" action="${cp}/empController/empRegist">
							...
							<div class="form-group row">
								...
								<div class="col-sm-2 input-group input-group-sm" style="float: left; margin-right: 10px;">
									<input type="text" name="zipcode" id="zipcode" placeholder="zipcode(우편번호)" style="width: 190px; background: #EEEEEE;" readonly="readonly"/>
								</div>
								<div class="col-sm-6 input-group input-group-sm">
									<input type="text" name="addr1" id="addr1" placeholder="addr1(주소)" style="width: 320px; background: #EEEEEE;" readonly="readonly"/>
								</div>
								
								<div class="col-sm-7 input-group input-group-sm" style="float: left; margin-right: 10px; margin-left: 110px;">
									<input type="text" name="addr2" id="addr2" placeholder="addr2(상세주소)" style="width: 430px;"/>
								</div>
