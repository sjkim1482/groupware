...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#appListConfirm").on("click", function() {
			...
			$(opener.document).find("#empMsgInfoList").text("");
			...
			$('.apptr').each(function() {
			    ...
			    $(opener.document).find("#empMsgInfoList").append(
			    	"<span>["+dept_nm+"/"+co_nm+"/"+name+"] </span>"
			    	+"<input type='hidden' name='msgEmpList' value='"+emp_no+"'>"
			    )
...
<body>
<h2 style="text-align: center;">수신자 지정</h2>
