...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<script>
      	$(function(){
			...
			$("#empPsmList").on("click", function() {
         		var win = window.open("${cp}/app/empInfoPMSList", "PopupWin", "width=900,height=500");
			...
			$("#registApp").on("click", function() {
				...
				var empPmsInfoList = $("#empPmsInfoList").text();
		
				
				if(empPmsInfoList==""){
					alert("프로젝트 참여자를 지정해주세요");
					return false;
				}
...
// 				if($("#s_dt").val()=="" || $("#e_dt").val()==""){
// 					alert("날짜를 지정해주세요");
// 					return false;
// 				}
				
				$("#appfrm").attr("method","POST");
				$("#appfrm").attr("action","${cp}/app/registPmsApp");
				$("#appfrm").submit();
			})
	...
	<form id="appfrm" enctype="multipart/form-data">
		...
		<div style="width: 100%; padding: 10px; background: white;"  >
			<h2 style="text-align: center;">프로젝트 신청서</h2>
			...
			<table border="1" style="width: 100%;">
				...
				<tr>
					<th style="text-align: center; background-color: #D8D8D8; height: 30px;" height="20"><strong>작업기간</strong></th>
					<td colspan="7">시작일 : <input type="date" id="s_dt" name="s_dt"> / 종료일 : <input type="date" id="e_dt" name="e_dt"> </td>
				</tr>
				
				<tr>
					<th style="text-align: center; background-color: #D8D8D8; height: 30px;" height="20"><strong>참여자</strong></th>
					<td id="empPmsInfoList" colspan="5"></td>
					<td style="float: right;" colspan="1" ><input type="button" id="empPsmList" value="참여자 지정"> </td>
				</tr>
				...
				<tr> 
					<td colspan="8">
						<textarea id="summernote" name="cont"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;</p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p><p style="text-align: center;"><b>- 아&nbsp; &nbsp;래&nbsp; -</b></p><p style="text-align: center;"><br></p><p><br></p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<b>1. 개요</b></p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; -&nbsp;&nbsp;<br></p><p><br></p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<b>2. 일시</b></p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;-&nbsp;&nbsp;<br></p><p><br></p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<b>3. 장소</b></p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;-&nbsp;&nbsp;</p><p><br></p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<b>4. 일정</b><br></p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;-&nbsp;&nbsp;</p><p><br></p><p><br></p><p><br></p><p><br></p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <b>별첨 :&nbsp;</b></p></textarea>
						<br>
